                            ...
                            filteredUsers.map((user, index) => (
                                <tr key={index} className="block mb-4">
                                    ...
                                    <td className="block text-right">
                                        <p className="min-w-96 mr-5"><br/>{user.nom}</p>
                                    </td>
                                    <td className="lg:justify-center block text-right">
                    ...
                    {admin === true ?
                        (
                            <button onClick={() => handleClick(users)}
                                    className="w-full lg:relative lg:float-right bg-amber-500 border-4 border-amber-500 rounded-xl mt-4">Update
                                stock
                            </button>
                        ) : ('')}
                </div>
